    ...
    function createTable(task_lists,week){
        ...
        $.each(task_lists, function(j, usr_task_list){
            ...
            $.each(weekDate, function(k, date){
                var tasktd = $('<td class="'+ date +'" id="'+usr_task_list.user_id+' '+ date +'" ondrop="onDrop( event, this );"ondragover="onDragOver( event );">')
